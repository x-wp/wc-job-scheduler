...
trait Job_Schedule_Methods {
    ...
    protected function default_hook() {
        return 'xwc_' . \strtolower( \basename( \str_replace( '\\', '/', static::class ) ) );
    }
    ...
    public function get_hook(): string {
        $hook = $this->has_hook() ? $this->hook : $this->default_hook();
    ...
    public function get_group(): string {
        return ! $this->has_hook() && ! $this->is_unique()
            ? 'xwc_job'
            : $this->group ?? '';
    }
